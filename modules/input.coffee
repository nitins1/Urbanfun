...
class exports.Input extends Layer
	...
	constructor: (options = {}) ->
		...
		@input.style.cssText = "outline: none; font-size: #{options.fontSize}px; line-height: #{options.lineHeight}px; padding: #{options.padding}px; padding-top: #{options.paddingTop}px; padding-Right: #{options.paddingRight}px; padding-left: #{options.paddingLeft}px; padding-Bottom: #{options.paddingBottom}px; width: #{options.width}px; height: #{options.height}px; border: none; background-image: url(about:blank); background-color: #{options.backgroundColor};"
